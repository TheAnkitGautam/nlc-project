import { Button, CardMedia, Checkbox, FormControlLabel, FormGroup, Paper, TextField, Typography } from "@mui/material"
            ...
            <Container elevation={4} component={Paper} sx={{ width: '450px', py: 8 }}>
                <Box sx={{ display: 'flex', alignItems: "center", justifyContent: 'center', mb: 3 }}>
                    <CardMedia
                        ...
                        alt="NLC Logo"
                    />
                    <Typography fontWeight={500} variant="h3" color="#282828">NLC</Typography>
                </Box>
                <Typography sx={{ mb: 8 }} align="center" variant="body2" color="#3a3541de">Please Sign-in to your account to continue.</Typography>
